...
#pragma mark Sandbox Crenditials
    ...
    txnParam.key = @"fB7m8s";
    txnParam.merchantid = @"fB7m8s";
    self.payu_salt = @"eRis5Chv";
...
/*
 ...
 PayUServiceHelper.sharedManager().getPayment(self, "mail@mymail.com", "9878767878", "Name", "Amount", txnid0011", didComplete: { (dict, error) in
 if let error = error {
